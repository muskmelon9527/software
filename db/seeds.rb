...
Notice.create!([
  {user_id: nil, title: "研究生Program-10网络选课说明", content: "2019年1月10日（星期四）中午12：30 —— 3月10日（星期日）下午17：00，期间网络开放，学生可选修、更改课程信息。"},
  {user_id: nil, title: "2018-2019学年春季学期研究生选课说明", content: "选课时间：2019年1月10日（星期四）中午12：30 ——2019年3月10日（星期日）下午17：00网络开放，学生可选修、更改课程及班级信息；其中1月18日12：30-1月23日上午10:00封网进行公选课抽签；《中国马克思主义与当代》1月16日12:30直博生开始选课，若有名额，硕士1月17日12:30开始选课；外语系课程选课时间及要求附后。3月10日17：00网络选课结束，网络封闭。请同学们务必在网络关闭前确认、提交选课信息。  "},
  {user_id: nil, title: "英语B课程增容选课通知", content: "英语B课程增容选课通知：{\r\n}为满足集中教学学生选课需求，英语B课程雁栖湖校区每班容量由34人增加至38人，选课时间为1月18日12：30至14:00。1月18日14:00之后选课系统封网开始公选课抽签，系统再次开放时间为1月23日10:00至3月10日17:00，请同学们相互转告!"}
])

Activity.create!([
  {user_id: nil, title: "科学前沿：深地震反射剖面揭示地壳结构与演化", class_room: "雁栖湖 教2-105", speaker: "高锐", when: "2019-01-10 13:30"},
  {user_id: nil, title: "科学前沿：精密重力测量的科学意义与研究应用", class_room: "雁栖湖 教2-229", speaker: "孙和平", when: "2019-01-07 14:00"},
  {user_id: nil, title: "科学前沿：共情与自闭症", class_room: "雁栖湖 教1-107", speaker: "王锦琰", when: "2019-01-03 18:30"}
])
...
teacher_map={
    1 => {name: "魏峻", department: "软件研究所"},
    2 => {name: "谢高岗", department: "计算机与控制学院"},
    3 => {name: "胡伟武", department: "软件研究所"},
...
course_map={
    ...
    1 => {course_code: "091M5023H", name: "数据挖掘", course_type: "专业普及课", credit: "46/2.0", limit_num: 450, course_week: "第2-14周	", course_time: "周一(1-2)", class_room: "教1-101", teaching_type: "课堂讲授为主", exam_type: "课堂开卷"},
    2 => {course_code: "091M5024H", name: "编译程序高级教程", course_type: "专业普及课", credit: "40/2.0", limit_num: "", course_week: "第2-18周	", course_time: "周一(5-7)", class_room: "教1-108", teaching_type: "课堂讲授为主", exam_type: "课堂开卷"},
    3 => {course_code: "091M5025H", name: "操作系统高级教程", course_type: "专业普及课", credit: "40/2.0", limit_num: "", course_week: "第2-12周	", course_time: "周三(7-8)", class_room: "教1-101", teaching_type: "课堂讲授为主", exam_type: "课堂开卷"},
    4 => {course_code: "091M5026H", name: "并发数据结构与多核编程", course_type: "专业普及课", credit: "40/2.0", limit_num: "", course_week: "第2-17周	", course_time: "周四(5-7)", class_room: "教1-109", teaching_type: "课堂讲授为主", exam_type: "课堂开卷"},
    5 => {course_code: "091M5027H", name: "形式语言与自动机理论", course_type: "专业普及课", credit: "40/2.0", limit_num: "", course_week: "第2-17周	", course_time: "周五(5-7)", class_room: "教1-113", teaching_type: "课堂讲授为主", exam_type: "课堂开卷"},
    6 => {course_code: "091M5041H", name: "人机交互", course_type: "专业普及课", credit: "40/2.0", limit_num: "", course_week: "第2-17周", course_time: "周三(5-7)", class_room: "教1-108", teaching_type: "课堂讲授为主", exam_type: "课堂开卷"},
    7 => {course_code: "091M5042H", name: "网络数据挖掘", course_type: "专业普及课", credit: "40/2.0", limit_num: "", course_week: "第2-17周	", course_time: "周二(5-7)", class_room: "教1-107", teaching_type: "课堂讲授为主", exam_type: "闭卷笔试"},
    8 => {course_code: "091M6043H", name: "认知计算", course_type: "专业研讨课", credit: "20/1.0", limit_num: 120, course_week: "第2-12周", course_time: "周四(5-6)	", class_room: "教1-123", teaching_type: "授课、讨论	", exam_type: "读书报告"},
    9 => {course_code: "091M6045H", name: "可视化与可视计算", course_type: "专业研讨课", credit: "20/1.0", limit_num: 120, course_week: "第2-8,10-12周	", course_time: "周五(5-6)", class_room: "教1-123", teaching_type: "授课、讨论	", exam_type: "读书报告"},
    10 => {course_code: "092M4001H", name: "最优控制理论", course_type: "专业核心课", credit: "60/3.0", limit_num: "", course_week: "第3-6,8-20周	", course_time: "周二(3-4)", class_room: "教1-109", teaching_type: "课堂讲授为主", exam_type: "闭卷笔试"},
...
(1..200).each do |index|
  student=User.create!(
      ...
      num: "2018#{Faker::Number.number(11)}",
