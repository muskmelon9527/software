...
Activity.create!([
  {user_id: nil, title: "深地震反射剖面揭示地壳结构与演化", class_room: "雁栖湖 教2-105", speaker: "高锐", when: "2019-01-10 13:30"},
  {user_id: nil, title: "精密重力测量的科学意义与研究应用", class_room: "雁栖湖 教2-229", speaker: "孙和平", when: "2018-01-07 14:00"},
  {user_id: nil, title: "明德讲堂M464：共情与自闭症", class_room: "雁栖湖 教1-107", speaker: "王锦琰", when: "2018-01-03 18:30"}
])
